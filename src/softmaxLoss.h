 ...
 *
 *  Pass in predictions, expected classes, number of classes, batch size to compute the softmax loss of the batch as well as the gradient of the loss with respect to the input predictions.
 *
