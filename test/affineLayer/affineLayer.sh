...
nvcc -O3 -arch=compute_$CC -code=sm_$CC -lcuda -Xcompiler -fopenmp -lineinfo -Xcompiler -rdynamic affineLayerTests.cu ../../src/affineLayer.cu -link -o "$outputFile"
